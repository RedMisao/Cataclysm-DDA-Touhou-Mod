Things that needs fixing (v 0.9.2.1)
...
3. Kaenbyou's Vengeful spirit release seems to do no damage to enemies, use at your own risk (Fix pending pending)
4. Utsuho's Fusion blade is currently not working
5. Implement spawning zones for the new (extinct) animals and youkai (In progress but most likely spawns either way too much or way too few monsters)
